...
In this letter, we report on the observation of a degraded and enhanced confinement state as a function of driven sheared-flows and that this confinement occurs regardless of flow or flow shear direction. We have shown that this variation in confinement correlates with increases and decreases in particle flux. Moreover, we can show that radial correlation length, particle flux, crossphase, density fluctuations and floating potential fluctions all decrease with shearing rate, and can each be fit to a power-law decay as predicted by theory. Lastly, we note that the various quantities effect by shearing are modified differently dependent on what frequency regime they are examimned.
