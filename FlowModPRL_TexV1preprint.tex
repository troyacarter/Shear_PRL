...
\begin{figure}
\begin{center}
\includegraphics[width=8.5cm]{velocity_flowshear.png}% Here is how to import EPS art
...
\begin{center}
\begin{figure}
\includegraphics[width=8.5cm]{densgrad.png}% Here is how to import EPS art
...
\begin{figure}
\begin{center}
\includegraphics[width=8.5cm]{shearandgrad.png}% Here is how to import EPS art
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=8.5cm]{fluxvsshear.png}% Here is how to import EPS art
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=8.5cm]{fluxcomps.png}% Here is how to import EPS art
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=8.5cm]{radcorr.png}% Here is how to import EPS art
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=8.5cm]{powercontour.png}% Here is how to import EPS art
\end{center}
\caption{\label{fig:powercontour} Contour plot of log isat fluctuation power versus shearing rate and frequency. Dashed lines show location of decorrelation rate.}
\end{figure}
